...
func init() {
    ...
    rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.tagger/config.yaml)")
...
func initConfig() {
    if cfgFile != "" {
        ...
        configDir := filepath.Join(home, ".tagger")
    ...
    viper.SetDefault("api.musicbrainz.user_agent", "tagger/0.1.0")
